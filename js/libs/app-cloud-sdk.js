  ...
  var init = function () {
    ...
    var touchend = function () {
      ...
      if(settings.scrollDirection === "vertical" ) {
        ...
        self.scrollToX(x1 + (deltaX * Math.abs(dx) * 0.75));
      }
    ...
    if( !bc.utils.hasTouchSupport() ) {
      $( ".scroller" ).on( "mousedown", "img", function( evt ) {
        evt.preventDefault();
        evt.stopPropagation();
      });
    }
...
( function( $, undefined ) {
  ...
  bc.ui.getScrollerForCurrentPage = function() {
    return bc.ui.currentPage.find( ".scroller" ).data( "bc-scroller" );
  };
